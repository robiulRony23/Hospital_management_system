...
public class Receptionist_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel2);
        jLabel2.setBounds(34, 14, 320, 40);
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        stmt=con.createStatement();
         ...
         String sql="SELECT * FROM RONY.RECEP_LOGIN WHERE USERNAME='"+usrnm+"' AND PASSWORD='"+usrpass+"'";
         rs=stmt.executeQuery(sql);
         
         if(rs.next())
         {
             logInInfo logininfo=new logInInfo();
             logininfo.receptionId=usrnm;
             logininfo.receptionPass=usrpass;
             Receptionist_home recphom=new Receptionist_home();
                       recphom.setVisible(true);
                       dispose();
         }
         else
         {
